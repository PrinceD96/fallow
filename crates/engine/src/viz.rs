...
pub struct VizFinding {
    ...
    #[serde(skip_serializing_if = "Vec::is_empty")]
    pub facts: Vec<VizFindingFact>,
    pub actions: Vec<VizFindingAction>,
}
...
pub struct VizSecurityTaintFlow {
    pub source: VizSecurityEndpoint,
    pub sink: VizSecurityEndpoint,
...
pub struct VizSecurityCandidate {
    ...
    pub severity: String,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub taint_confidence: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub reachable_from_untrusted_source: Option<bool>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub blast_radius: Option<u32>,
    pub crosses_boundary: bool,
    pub client_server_boundary: bool,
    pub cross_module_boundary: bool,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub architecture_zone: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub dead_code: Option<Value>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub runtime: Option<Value>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub taint_flow: Option<VizSecurityTaintFlow>,
    #[serde(skip_serializing_if = "Vec::is_empty")]
    pub observed_controls: Vec<Value>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub control_verification_prompt: Option<String>,
    pub trace: Vec<VizSecurityTraceHop>,
    #[serde(skip_serializing_if = "Vec::is_empty")]
    pub taint_trace: Vec<VizSecurityTraceHop>,
    pub actions: Value,
}
